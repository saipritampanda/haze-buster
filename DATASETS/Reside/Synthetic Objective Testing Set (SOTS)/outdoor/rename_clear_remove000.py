...
clear_dir = Path(r"C:\Users\SAI PRITAM PANDA\Desktop\SDP Project\DATASETS\Reside\Synthetic Objective Testing Set (SOTS)\outdoor\clear")

# Get all hazy images
hazy_images = sorted([f for f in clear_dir.iterdir() if f.is_file()])
